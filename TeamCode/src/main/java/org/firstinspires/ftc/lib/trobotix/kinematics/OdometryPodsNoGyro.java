...
public class OdometryPodsNoGyro {
  ...
  public OdometryPodsNoGyro(OdometryPodKinematics kinematics, Pose2d initialPose) {
    this.kinematics = kinematics;
    poseMeters = initialPose;
    previousWheelPositions = new OdometryPodWheelPositions(new double[kinematics.podCount]);
  }

  public OdometryPodsNoGyro(OdometryPodKinematics kinematics) {
    this(kinematics, Pose2d.kZero);
  }

  public OdometryPodsNoGyro(Transform2d... pods) {
